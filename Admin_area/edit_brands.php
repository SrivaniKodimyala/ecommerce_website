...
{
    $brand_tittle = $_POST['brand_title'];
    $update_query = "UPDATE `brands` SET brand_tittle = '$brand_tittle' WHERE brand_id = $edit_brand";
...
<div class="container mt-3">
    ...
    <form action="" method="post" class="text-center">
       <div class="form-outline mb-4 w-50 m-auto">
        ...
        required="required" value="<?php echo $brand_tittle; ?>">
</div>

...
while($row_price=mysqli_fetch_array($result_cart_price)){
    ...
    while($row_product_price = mysqli_fetch_array($run_price)) {
            $product_price = array($row_product_price['product_price']); // Correct variable name
            $product_values = array_sum($product_price); // Sum the values of the array
            $total_price+= $product_values; // Add to total price
        }
    }
